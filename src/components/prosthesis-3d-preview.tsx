...
export const PROSTHESIS_MODELS: ProsthesisModel[] = [
  {
    id: "knee",
    name: "Joelho Modular X1",
    description: "Articulação de joelho com pivô central em titânio e sleeve em polímero médico.",
    category: "Membro inferior",
    basePrice: 18500,
  },
  {
    id: "hip",
    name: "Quadril Anatômico H2",
    description: "Cabeça esférica e haste femoral com acabamento poroso para osteointegração.",
    category: "Membro inferior",
    basePrice: 24900,
  },
  {
    id: "leg",
    name: "Perna Transtibial L3",
    description: "Soquete anatômico com pilão de fibra de carbono e adaptador universal.",
    category: "Membro inferior",
    basePrice: 21500,
  },
  {
    id: "foot",
    name: "Pé Dinâmico F1",
    description: "Lâmina de retorno de energia em fibra de carbono para caminhada ativa.",
    category: "Membro inferior",
    basePrice: 14200,
  },
  {
  ...
  {
    id: "arm",
    name: "Braço Transradial A2",
    description: "Soquete de encaixe com terminal universal para ferramentas modulares.",
    category: "Membro superior",
    basePrice: 19800,
  },
];
